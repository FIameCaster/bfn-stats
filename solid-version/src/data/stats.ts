import { Ability } from "../pages/Classes/Abilities"

let getAbilities: (index: number, modifiers: number[]) => Ability[]
...
const getStats = (id: number) => new Character(id)
...
const weaponData = [
	...
	[330,45,2,,,,[[6.5,1,.5,75,.55,,,,32,12,19]],[,,1,1,.5,-.1,.1,100],,,[0,1,1,15,0,0,0,.25],,,[0,.1,2.5,30,1]],
